...
var socket = new WebSocket('ws://192.168.1.30:8081/', 'gen03');  
var decoder = null;
var dataSiswa;
...
function displayDailyAbsent(){  //menampilkan data absen hari ini
  ...
  const options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
  document.getElementById("labelSelectedDate").innerHTML = new Date(document.getElementById("date").value).toLocaleDateString('en-ID', options) + "&nbsp;&nbsp;";
